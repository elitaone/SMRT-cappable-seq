...
# Modification: April 5, 2019, modify cluster function to be applied to all the genomes. Originally only for E.coli NC_000913.3.
...
def main_countreads(input_bed, output_bed):
    ...
    if len(set(chr)) >1:
        print "There are more than one genome used for mapping, please extract the reads that are only mapped to one targeting bacterial genome!"
        print "Quit."
        quit()
